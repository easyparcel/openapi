...
| coll_country_code    | string(2)   | Yes      | Sender's country code (refer to (refer to [country code](../References/Country%20Code.md))   |
...
| deli_country_code    | string(2)   | Yes      | Receiver's country code (refer to (refer to [country code](../References/Country%20Code.md) |
...
| coll_province_code   | string     | Sender's province code (refer to (refer to [ISO 3166](../References/ISO%3166.md))           |
| coll_country_code    | string     | Sender's country code (refer to (refer to [country code](../References/Country%20Code.md))  |
