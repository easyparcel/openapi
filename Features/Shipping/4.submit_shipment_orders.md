...
| phone_number_country_code | string    | Yes      | Country code of the Phone number origin | refer to [Country Code](../../References/Country%20Code.md) |
...
| country_code              | string(2) | Yes      | the origin country of the parcel        | refer to [Country Code](../../References/Country%20Code.md) |
...
| phone_number_country_code | string    | Yes      | Country code of the Phone number origin | refer to [country code](#country-code)                      |
...
| province_code             | string    | Yes      | Receiver's province                     | refer to [ISO 3166](../../References/ISO%203166.md)         |
